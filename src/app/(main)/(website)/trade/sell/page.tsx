        ...
        <div className={`${styles.mainContainer}`}>
            ...
            <div className={styles.productDescContainer}>
                <div className={styles.productText}>
                    <h2>Sell Gift Cards For</h2>
                    <h2>Nigerian Naira</h2>
                    {/* <h2><span className={styles.tradingText}>Nigerian</span> Gift cards</h2> */}
                    <div className={styles.secondText}>We accept different Gift card types, you can get paid in Naira.</div>
            ...
            <div className={styles.howtoContainer}>
                ...
                <div className={styles.howToItemContainer}>
                    ...
                    <HowToItem
                        ...
                        desc='Select the brand of Gift card you want to sell.'
                    />
                    {/* <HowToItem
                        number='4'
                        title='Choose Naira'
